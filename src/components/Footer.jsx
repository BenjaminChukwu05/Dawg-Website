...
export default function Footer() {
    ...
    const contactInfo = [
        {
            icon: <MdEmail />,
            value: "chukwubenjamin05@gmail.com",
        },
        {
            icon: <MdPhoneInTalk />,
            value: "+(234) 706-321-1130",
        },
        {
            icon: <IoLocationSharp />,
            value: "147, Brickfield Street, Apapa Road, Ebute-metta",
        },
    ];
    const socialIcons = [
        <AiFillFacebook />,
  ...
  return (
    <Container>
        <div className="row">
            ...
            <p className="description">147, Brickfield Street, Apapa Road, Ebute-metta</p>
